...
//    ] }
    ...
    $translateProvider.translations('de', {
      ...
      "helptext registration company": "Gib den Namen der Firma oder der Person an, die diese Aktivität anbietet.",
      "helptext registration contact person": "Gib uns den Namen der Person an, mit der wir unter der oben genannten Nummer in Kontakt treten können.",
      "helptext activity name": "Gib Deiner Aktivität einen Namen! Dieser sollte beschreiben, was Du anbietest.",
      "helptext activity meeting spot": "Gib an, wo Dich Deine Kunden treffen werden.",
      "helptext activity short descricption": "",
      "helptext activity description": "Beschreibe Deine Aktivität! Je mehr Details Du angibst, umso eher wirst Du Buchungen erhalten. Wichtig sind alle Informationen, die Deine Kunden interessieren könnten. Ist bei Deiner Stadttour ein Restaurantbesuch inkludiert? Sprichst Du mehrere Sprachen? Wie lange bist Du schon in Deinem Bereich tätig? Müssen Deine Kunden selbst etwas mitnehmen (Kleidung, Schuhe, Schlafsack …)? Prinzipiell gilt: Je mehr Infos umso besser für Dich und Deine Kunden! Verwende die Layout Funktion, um wichtige Informationen hervorzuheben!",
      "helptext activity item description": "Beschreibe in einem kurzen Satz, was genau Deine Kunden buchen können.",
      "helptext activity start date": "Gib an, wann diese Aktivität das erste Mal stattfindet.",
      "helptext activity start time": "Gib an, um welche Uhrzeit Deine Kunden am Treffpunkt sein sollen.",
      "helptext activity end date": "Gib an, wieviele Tage diese Aktivität dauert.",
    ...
    $translateProvider.translations('it', {
      ...
      "helptext activity meeting spot": "Allows you to choose where you will meet your customers.",
      "helptext activity short descricption": "",
      "helptext activity description": "descrivi la tua attività! maggiori dettagli fornirai, maggiori saranno le probabilità di ricevere prenotazione. Inserisci tutte le informazioni che potrebbero interessare ai tuoi clienti. Il tuo city tour include un pasto? Quali lingue parli? Da quanto tempo fornisci questo servizio? I tuoi clienti necessitano di portare con se’ delle attrezzature (vestiti, scarpe, sacco a pelo..)? Usa un carattere particolare per evidenziare le informazioni più importanti.",
      "helptext activity item description": "descrivi con una frase breve cosa possono prenotare esattamente i tuoi clienti",
      "helptext activity start date": "scegli quando questa attività avrà luogo la prima volta",
      "helptext activity start time": "Indica a che ora i clienti devono trovarsi al punto d’incontro",
      "helptext activity end date": "Indica la data in cui la tua attività termina. Normalmente lo stesso giorno, ore dopo ",
      "helptext activity end time": "Allows you to choose when your activity ends.",
    ...
    $translateProvider.translations('fr', {
      ...
      "helptext activity meeting spot": "Allows you to choose where you will meet your customers.",
      "helptext activity short descricption": "",
      "helptext activity description": "décrivez Votre activité! Insérez la majorité de détails et la possibilité de recevoir des réservations sera majeure. Nous Vous conseillons d’insérer toutes les informations qui pourraient être utiles à Vos clients afin de mieux comprendre de quoi il s’agit. Votre tour de la ville inclut un plat ? Combien de langues parlez-Vous ?De combien de temps Vous avez cette activité ? Vos clients nécessitent de vêtements spécifiques ou équipement particulier ? Utilisez un caractère différent pour remarquer les information les plus importantes.",
      "helptext activity item description": "décrivez brièvement et précisément ce que les clients peuvent réserver",
      "helptext activity start date": "indiquez quand l’activité aura lieu",
      "helptext activity start time": "indiquez l’horaire à laquelle vos client vont se regrouper au point de rencontre",
      "helptext activity end date": "indiquez quand l’activité terminera",
      "helptext activity end time": "Allows you to choose when your activity ends.",
